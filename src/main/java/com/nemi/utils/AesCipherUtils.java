...
import com.nemi.utils.security.EncryptionStrength;
...
public class AesCipherUtils {
    ...
    // Dùng thuật toán "PBKDF2WithHmacSHA256" để chuyển mật khẩu → khóa mã hóa.
    // Thêm salt để tránh tấn công rainbow table
    //  ùng 65536 vòng lặp để làm chậm brute-force.
