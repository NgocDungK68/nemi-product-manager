...
public enum SyncErrorMessage {
    ...
    PRODUCT_CONNECTION_FAILED("No response from partner API when fetching products"),
    ...
    ORDER_CONNECTION_FAILED("No response from partner API when fetching orders"),
